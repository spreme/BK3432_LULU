...
{	
    ...
    {				
        ...
        memcpy(&cmd->info.host.adv_data[0], adv_gma_data, sizeof(adv_gma_data)/sizeof(adv_gma_data[0]));
        cmd->info.host.adv_data_len = sizeof(adv_gma_data)/sizeof(adv_gma_data[0]);
#endif
