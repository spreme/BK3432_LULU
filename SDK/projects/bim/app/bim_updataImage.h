...
#define SEC_IMAGE_BOOT_AND_STACK            92 ////boot+stack=92k

#define SEC_MAX_FSIZE_APP_BLOCK		         ((((160-SEC_IMAGE_BOOT_AND_STACK)/2)*1024)/16)  

#define SEC_IMAGE_RUN_APP_FADDR				 (SEC_IMAGE_BOOT_AND_STACK*1024+0x20)  //(0x15820)//86K
#define SEC_IMAGE_RUN_STACK_FADDR			 (0x1020) 

#define SEC_IMAGE_OAD_HEADER_APP_FADDR		 (SEC_IMAGE_BOOT_AND_STACK*1024+0x10)  //(0x15810) 																		
#define SEC_IMAGE_OAD_HEADER_STACK_FADDR	 (0x1010) 

#define SEC_IMAGE_ALLOC_START_APP_FADDR		 (SEC_IMAGE_BOOT_AND_STACK*1024)  //(0x15800) //(86KB)
#define SEC_IMAGE_ALLOC_START_STACK_FADDR	 (0x1000)  //(4KB)


#define SEC_BACKUP_OAD_HEADER_FADDR			 (SEC_IMAGE_BOOT_AND_STACK+(160-SEC_IMAGE_BOOT_AND_STACK)/2)*1024 //(0x1D800) //118kb * 1024
#define SEC_BACKUP_OAD_IMAGE_FADDR			 ((SEC_IMAGE_BOOT_AND_STACK+(160-SEC_IMAGE_BOOT_AND_STACK)/2)*1024+0x10) //(0x1D810) //118kb * 1024 + 0X10
#define SEC_BACKUP_ALLOC_START_FADDR		 (SEC_IMAGE_BOOT_AND_STACK+(160-SEC_IMAGE_BOOT_AND_STACK)/2)*1024 //(0x1D800) //(118KB)
#define SEC_BACKUP_ALLOC_END_FADDR			 (0x27FF0) //(160KB)
