...
#define USER_SERV_UUID_128  {0xe2, 0xa4, 0x1b, 0x54, 0x93, 0xe4, 0x6a, 0xb5, 0x20, 0x4e, 0xd0, 0x65, 0x00, 0x00, 0x00, 0x00}

#define USER_CHAR_UUID_128  {0xe2, 0xa4, 0x1b, 0x54, 0x93, 0xe4, 0x6a, 0xb5, 0x20, 0x4e, 0xd0, 0x65, 0x00, 0x00, 0x00, 0x00}
...
uint8_t attm_util_svc_create_db128(uint16_t *shdl, uint16_t uuid, uint8_t *cfg_flag, uint8_t max_nb_att,uint8_t *att_tbl, ke_task_id_t const dest_id,const struct attm_desc *att_db, uint8_t svc_perm)
{
	...
	UART_PRINTF("add srv nb_att4=%d\r\n",nb_att);
    // add service in database
	status = attmdb_add_service(svc_desc);
	  	UART_PRINTF("add srv nb_att5=%d\r\n",nb_att);
