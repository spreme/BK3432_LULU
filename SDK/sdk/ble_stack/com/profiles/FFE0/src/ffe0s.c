...
const struct attm_desc_128 ffe0_att_db[FFE0S_IDX_NB] =
{
	// FFF0 Service Declaration
	[FFE0S_IDX_SVC]                  =   {{0x00,0x28},  PERM(RD, ENABLE), 0, 0},
	// fff1 Level Characteristic Declaration
	[FFE0S_IDX_FFE1_VAL_CHAR]        =   {{0x03,0x28},   PERM(RD, ENABLE), 0, 0},
	// fff1 Level Characteristic Value
	[FFE0S_IDX_FFE1_VAL_VALUE]       =   {{0xe2, 0xa4, 0x1b, 0x54, 0x93, 0xe4, 0x6a, 0xb5, 0x20, 0x4e, 0xd0, 0x65, 0xe0, 0xff, 0x00, 0x00,}, 
										 PERM(WRITE_REQ, ENABLE), PERM(UUID_LEN, UUID_128)|PERM(RD, ENABLE) , LLSYNC_CHAR_VAL_LEN_MAX },
										 
	[FFE0S_IDX_FFE2_VAL_CHAR]        =   {{0x03,0x28},   PERM(RD, ENABLE), 0, 0},
	// fff1 Level Characteristic Value
	[FFE0S_IDX_FFE2_VAL_VALUE]       =   {{0xe2, 0xa4, 0x1b, 0x54, 0x93, 0xe4, 0x6a, 0xb5, 0x20, 0x4e, 0xd0, 0x65, 0xe0, 0xff, 0x00, 0x00,}, 
										 PERM(WRITE_REQ, ENABLE), PERM(UUID_LEN, UUID_128)|PERM(RD, ENABLE) , LLSYNC_CHAR_VAL_LEN_MAX },	
										 
	[FFE0S_IDX_FFE3_VAL_CHAR]        =   {{0x03,0x28},   PERM(RD, ENABLE), 0, 0},
	// fff1 Level Characteristic Value
	[FFE0S_IDX_FFE3_VAL_VALUE]       =   {{0xe2, 0xa4, 0x1b, 0x54, 0x93, 0xe4, 0x6a, 0xb5, 0x20, 0x4e, 0xd0, 0x65, 0xe0, 0xff, 0x00, 0x00,}, 
										 0, PERM(UUID_LEN, UUID_128)|PERM(RD, ENABLE) , LLSYNC_CHAR_VAL_LEN_MAX },

	[FFE0S_IDX_FFE3_VAL_NTF_CFG] =       {{0x02,0x29},  PERM(RD, ENABLE)|PERM(WRITE_REQ, ENABLE), 0, 0},

	[FFE0S_IDX_FFE4_VAL_CHAR]        =   {{0x03,0x28},   PERM(RD, ENABLE), 0, 0},
	// fff1 Level Characteristic Value
	[FFE0S_IDX_FFE4_VAL_VALUE]       =   {{0xe2, 0xa4, 0x1b, 0x54, 0x93, 0xe4, 0x6a, 0xb5, 0x20, 0x4e, 0xd0, 0x65, 0xe0, 0xff, 0x00, 0x00,}, 
										 PERM(WRITE_COMMAND, ENABLE), PERM(UUID_LEN, UUID_128)|PERM(RD, ENABLE) , LLSYNC_CHAR_VAL_LEN_MAX },
...
const struct attm_desc ffe0_att_db[FFE0S_IDX_NB] =
{
	...
	// fff1 Level Characteristic Value
	[FFE0S_IDX_FFE1_VAL_VALUE]       =   {ATT_CHAR_FFE0_FFE1,  PERM(WRITE_REQ, ENABLE), PERM(UUID_LEN, UUID_128)|PERM(RD, ENABLE) , LLSYNC_CHAR_VAL_LEN_MAX },
										 
	[FFE0S_IDX_FFE2_VAL_CHAR]        =   {ATT_DECL_CHARACTERISTIC,   PERM(RD, ENABLE), 0, 0},
	// fff1 Level Characteristic Value
	[FFE0S_IDX_FFE2_VAL_VALUE]       =   {ATT_CHAR_FFE0_FFE2,  PERM(WRITE_REQ, ENABLE), PERM(UUID_LEN, UUID_128)|PERM(RD, ENABLE) , LLSYNC_CHAR_VAL_LEN_MAX },	
										 
	[FFE0S_IDX_FFE3_VAL_CHAR]        =   {ATT_DECL_CHARACTERISTIC,   PERM(RD, ENABLE), 0, 0},
	// fff1 Level Characteristic Value
	[FFE0S_IDX_FFE3_VAL_VALUE]       =   {ATT_CHAR_FFE0_FFE3,  PERM(NTF, ENABLE) , PERM(UUID_LEN, UUID_128)|PERM(RD, ENABLE) , LLSYNC_CHAR_VAL_LEN_MAX },

	[FFE0S_IDX_FFE3_VAL_NTF_CFG] =       {ATT_DESC_CLIENT_CHAR_CFG,  PERM(RD, ENABLE)|PERM(WRITE_REQ, ENABLE), 0, 0},

	[FFE0S_IDX_FFE4_VAL_CHAR]        =   {ATT_DECL_CHARACTERISTIC,   PERM(RD, ENABLE), 0, 0},
	// fff1 Level Characteristic Value
	[FFE0S_IDX_FFE4_VAL_VALUE]       =   {ATT_CHAR_FFE0_FFE4,  PERM(WRITE_COMMAND, ENABLE), PERM(UUID_LEN, UUID_128)|PERM(RD, ENABLE) , LLSYNC_CHAR_VAL_LEN_MAX },
...
static uint8_t ffe0s_init (struct prf_task_env* env, uint16_t* start_hdl, uint16_t app_task, uint8_t sec_lvl,  struct ffe0s_db_cfg* params)
{
 ...
 //   status = attm_svc_create_db_128(&(shdl), llsync_service_uuid, (uint8_t *)&cfg_flag,
  ...
  //          (sec_lvl & (PERM_MASK_SVC_DIS | PERM_MASK_SVC_AUTH | PERM_MASK_SVC_EKS|PERM_MASK_SVC_UUID_LEN)));
	...
	status = attm_util_svc_create_db128(&(shdl), ATT_SVC_FFE0, (uint8_t *)&cfg_flag,
	       FFE0S_IDX_NB, NULL, env->task, &ffe0_att_db[0],
	      (sec_lvl & (PERM_MASK_SVC_DIS | PERM_MASK_SVC_AUTH | PERM_MASK_SVC_EKS)));	
	UART_PRINTF("ffe0s_init status=%d\r\n",status);
...
uint8_t ffe0s_get_att_idx(uint16_t handle, uint8_t *att_idx)
{
    ...
    if(handle <= (hdl_cursor + FFE0S_IDX_FFE4_VAL_VALUE))
    {
