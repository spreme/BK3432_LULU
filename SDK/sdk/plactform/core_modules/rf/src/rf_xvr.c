...
uint32_t XVR_ANALOG_REG_BAK[16] = {0};
...
{ 
    ...
    XVR_ANALOG_REG_BAK[0x4]=0X5F915ECB;
    XVR_REG05 = 0X48205213;//0X48205211; // REG_5  
    XVR_ANALOG_REG_BAK[0x5]=0X48205213;
    XVR_REG06 = 0XE4FA0A00;//0X847A8A00; // REG_6  
    XVR_ANALOG_REG_BAK[0x6]=0XE4FA0A00;
    XVR_REG07 = 0XAA007FC4;//0XAA007DC4;//0XAA003DC4; // REG_7  
    XVR_ANALOG_REG_BAK[0x7]=0XAA007FC4;
    XVR_REG08 = 0X07C08005;//0X7C1C00d ; // REG_8  
    XVR_ANALOG_REG_BAK[0x8]=0X07C08005;
...
void bk3432_set_power(uint8_t power_level)
{
	uint32_t val = 0;
...
void xtal_cal_set(uint8_t cal_data)
{
    if(cal_data>0x0f)
        cal_data=0x0f;
    XVR_REG07 = (0XAA003FC4|(cal_data<<14));
}
