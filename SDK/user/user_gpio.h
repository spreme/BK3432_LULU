...
//	#define SET_KEY			0x00				//设置按键
//	#define DOWN_KEY		0x07				//下按键
//	#define UP_KEY			0x06				//上按键
//	#define LOCK_KEY		0x05				//解锁按键

	#define RECORD_KEY		0x06				//录音按键
	#define FEED_KEY		0x14				//喂食按键
	#define SET_KEY			0x00				//设置按键
	#define DOWN_KEY		0x05				//下按键
	#define UP_KEY			0x35				//上按键
	#define LOCK_KEY		0x07				//解锁按键

	#define HT1621_DAT 		0x03
	#define HT1621_WR 		0x02	
//	#define HT1621_RD 			
	#define HT1621_CS 		0x04	
...
//##################################### PT01K_BK ##################################################//
	...
	#define UP_KEY			0x05				//上按键
//	#define DOWN_KEY		0x14				//下按键
	#define DOWN_KEY		0x01				//下按键
	#define SET_KEY			0x00				//设置按键
	#define RECORD_KEY		0x35				//录音按键
